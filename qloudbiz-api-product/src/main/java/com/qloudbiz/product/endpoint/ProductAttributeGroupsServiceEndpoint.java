...
public class ProductAttributeGroupsServiceEndpoint {
	...
	private final static String PATH_ADD_ATTRIBUTE_GROUPS_JSON = "com/qloudfin/qloudbiz/apidef/products/product-attributes-group-create.json";
	...
	public void addAttributeGroups(Callback<Object> callback, Map<String,String> body) {
		...
		//读取json数据
		String content = FileUtils.getResourceContent(PATH_ADD_ATTRIBUTE_GROUPS_JSON);
	...
	public void updateAttributeGroups(Callback<Object> callback,@PathVariable("groupId") String groupId, Map<String,String> body) {
		...
		//调试日志
		logger.debug("=======Update attributeGroups : groupId is :{},param is {}", groupId, body);
	...
	public void deleteAttributeGroups(Callback<Object> callback, @PathVariable("groupId") String groupId) {
		...
		//调试日志
		logger.debug("=======Update attributeGroups : groupId is :{},param is {}", groupId);
	...
	public void queryAttributeGroupsINF(Callback<Object> callback, @PathVariable("groupId") String groupId){
		 //调试日志
		logger.debug("Query attributeGroupsINF");
